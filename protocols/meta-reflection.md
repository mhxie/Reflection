...
| **Epistemic Independence** | Is the ratio of AI-tagged to user-written content shifting? Are `#ai-originated` items increasing? See `protocols/epistemic-hygiene.md`. |
